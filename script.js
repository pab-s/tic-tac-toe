...
btn.addEventListener('click', function () {
  ...
  intro.className = 'animate-out popup' // intro disapires
})
...
function checkIfEmpty (rowNum, colNum) {
...
function winnerFeedBack (player) {
  if (player === pcLetter) {
...
// display feedback
function displayFeedback (playerName) {
...
function gameWinner (playerLetter) {
